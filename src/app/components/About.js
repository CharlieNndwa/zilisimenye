...
const About = () => {
  return (
    ...
    >
      <p className="text-2xl lg:text-4xl font-bold">About Us <Image src={Lotus} alt='lotus' className='ml-4 ' /></p>
      <p className="text-body text-xl lg:text-xl w-full md:w-8/12 text-center my-4">
